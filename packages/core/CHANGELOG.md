...
- d155a43: - Add support for BDT, COP, EGP, GHS, HTG, JMD, PKR currencies
...
- 97769ad: - Replace secp256k1 with @noble/curves: The native secp256k1 npm package (which requires native compilation/bindings) has been replaced with @noble/curves/secp256k1, a
