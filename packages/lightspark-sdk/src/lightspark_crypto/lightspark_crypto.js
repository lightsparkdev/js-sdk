...
/**
 */
module.exports.Network = Object.freeze({
  Bitcoin: 0,
  0: "Bitcoin",
  Testnet: 1,
  1: "Testnet",
...
class LightsparkSigner {
  ...
  derive_public_key(derivation_path) {
    ...
    try {
      ...
      const len0 = WASM_VECTOR_LEN;
      wasm.lightsparksigner_derive_public_key(
        retptr,
        this.__wbg_ptr,
        ptr0,
        len0,
  ...
  derive_key_and_sign(message, derivation_path, is_raw, add_tweak, mul_tweak) {
    try {
      ...
      var ptr2 = isLikeNone(add_tweak)
        ? 0
        : passArray8ToWasm0(add_tweak, wasm.__wbindgen_malloc);
      var len2 = WASM_VECTOR_LEN;
      var ptr3 = isLikeNone(mul_tweak)
        ? 0
        : passArray8ToWasm0(mul_tweak, wasm.__wbindgen_malloc);
      var len3 = WASM_VECTOR_LEN;
      wasm.lightsparksigner_derive_key_and_sign(
        retptr,
        this.__wbg_ptr,
        ptr0,
        len0,
  ...
  get_per_commitment_point(derivation_path, per_commitment_point_idx) {
    try {
      ...
      const len0 = WASM_VECTOR_LEN;
      wasm.lightsparksigner_get_per_commitment_point(
        retptr,
        this.__wbg_ptr,
        ptr0,
        len0,
  ...
  release_per_commitment_secret(derivation_path, per_commitment_point_idx) {
    try {
      ...
      const len0 = WASM_VECTOR_LEN;
      wasm.lightsparksigner_release_per_commitment_secret(
        retptr,
        this.__wbg_ptr,
        ptr0,
        len0,
  ...
  generate_preimage(nonce) {
    try {
      ...
      const len0 = WASM_VECTOR_LEN;
      wasm.lightsparksigner_generate_preimage(
        retptr,
        this.__wbg_ptr,
        ptr0,
        len0,
  ...
  generate_preimage_hash(nonce) {
    try {
      ...
      const ptr0 = passArray8ToWasm0(nonce, wasm.__wbindgen_malloc);
      const len0 = WASM_VECTOR_LEN;
      wasm.lightsparksigner_generate_preimage_hash(
        retptr,
        this.__wbg_ptr,
        ptr0,
        len0,
  ...
  derive_private_key(derivation_path) {
    ...
    try {
      ...
      const len0 = WASM_VECTOR_LEN;
      wasm.lightsparksigner_derive_private_key(
        retptr,
        this.__wbg_ptr,
        ptr0,
        len0,
  ...
  sign_invoice_wasm(unsigned_invoice) {
    try {
      ...
      const len0 = WASM_VECTOR_LEN;
      wasm.lightsparksigner_sign_invoice_wasm(
        retptr,
        this.__wbg_ptr,
        ptr0,
        len0,
  ...
  sign_invoice_hash_wasm(invoice_hash) {
    try {
      ...
      const len0 = WASM_VECTOR_LEN;
      wasm.lightsparksigner_sign_invoice_hash_wasm(
        retptr,
        this.__wbg_ptr,
        ptr0,
        len0,
...
const path = require("path").join(__dirname, "lightspark_crypto_bg.wasm");
