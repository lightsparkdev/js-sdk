...
interface ChannelToTransactionsConnection {
  ...
  /**
   * The average fee for the transactions that transited through this
   ...
   * this channel, according to the filters and constraints of the
   * connection.
   **/
  totalAmountTransacted?: CurrencyAmount | undefined;

  /**
   * The total amount of fees for the transactions that transited through
   * this channel, according to the filters and constraints of the
   * connection.
   **/
