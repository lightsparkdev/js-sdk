...
export const IconSecretPhrase: FC<CentralIconBaseProps> = (props) => (
  <CentralIconBase {...props} ariaLabel="secret-phrase, code, private-phrase">
    <path
...
export default IconSecretPhrase;
