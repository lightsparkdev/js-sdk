...
import {
  ...
  Breakpoints,
  useBreakpoints,
} from "@lightsparkdev/ui/styles/breakpoints";
import {
  overlaySurface,
  smContentInset,
  standardContentInsetSmPx,
  standardFocusOutline,
} from "@lightsparkdev/ui/styles/common";
import {
  overflowAutoWithoutScrollbars,
  pxToRems,
} from "@lightsparkdev/ui/styles/utils";
...
type ModalProps = {
  ...
  /* most of the time this is an Element but not in the case of Select - it just extends .focus method: */
  firstFocusRef?: MutableRefObject<{ focus: () => void } | null>;
  /* This should always be true for accessibility purposes unless you are managing focus in a child component */
  autoFocus?: boolean;
