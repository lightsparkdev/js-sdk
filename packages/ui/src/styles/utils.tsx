 ...
 * even if we adapt SSR in the future. So far in testing it only works in root
 * level styled component declarations and not inlined style functions.
 * It is very sensitive to changes so be sure to test thoroughly that there are
 * no console warnings in any usage:
 */
